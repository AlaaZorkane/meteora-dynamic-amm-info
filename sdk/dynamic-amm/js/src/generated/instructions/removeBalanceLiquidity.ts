...
export const REMOVE_BALANCE_LIQUIDITY_DISCRIMINATOR = new Uint8Array([
  133, 109, 44, 179, 56, 238, 114, 33,
]);

export function getRemoveBalanceLiquidityDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    REMOVE_BALANCE_LIQUIDITY_DISCRIMINATOR
  );
}

export type RemoveBalanceLiquidityInstruction<
...
export type RemoveBalanceLiquidityInstructionData = {
...
export type RemoveBalanceLiquidityInstructionDataArgs = {
  poolTokenAmount: number | bigint;
  minimumATokenOut: number | bigint;
  minimumBTokenOut: number | bigint;
};

export function getRemoveBalanceLiquidityInstructionDataEncoder(): Encoder<RemoveBalanceLiquidityInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ['discriminator', fixEncoderSize(getBytesEncoder(), 8)],
      ['poolTokenAmount', getU64Encoder()],
      ['minimumATokenOut', getU64Encoder()],
      ['minimumBTokenOut', getU64Encoder()],
    ]),
    (value) => ({
      ...value,
      discriminator: REMOVE_BALANCE_LIQUIDITY_DISCRIMINATOR,
    })
  );
}

export function getRemoveBalanceLiquidityInstructionDataDecoder(): Decoder<RemoveBalanceLiquidityInstructionData> {
  return getStructDecoder([
    ['discriminator', fixDecoderSize(getBytesDecoder(), 8)],
    ['poolTokenAmount', getU64Decoder()],
    ['minimumATokenOut', getU64Decoder()],
    ['minimumBTokenOut', getU64Decoder()],
  ]);
}

export function getRemoveBalanceLiquidityInstructionDataCodec(): Codec<
  RemoveBalanceLiquidityInstructionDataArgs,
  RemoveBalanceLiquidityInstructionData
> {
  return combineCodec(
    getRemoveBalanceLiquidityInstructionDataEncoder(),
    getRemoveBalanceLiquidityInstructionDataDecoder()
  );
}

export type RemoveBalanceLiquidityInput<
...
> = {
  ...
  poolTokenAmount: RemoveBalanceLiquidityInstructionDataArgs['poolTokenAmount'];
  minimumATokenOut: RemoveBalanceLiquidityInstructionDataArgs['minimumATokenOut'];
  minimumBTokenOut: RemoveBalanceLiquidityInstructionDataArgs['minimumBTokenOut'];
};

export function getRemoveBalanceLiquidityInstruction<
  TAccountPool extends string,
  TAccountLpMint extends string,
  TAccountUserPoolLp extends string,
  TAccountAVaultLp extends string,
...
>(
  input: RemoveBalanceLiquidityInput<
    TAccountPool,
    TAccountLpMint,
    TAccountUserPoolLp,
    TAccountAVaultLp,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getRemoveBalanceLiquidityInstructionDataEncoder().encode(
      args as RemoveBalanceLiquidityInstructionDataArgs
    ),
  } as RemoveBalanceLiquidityInstruction<
    TProgramAddress,
    TAccountPool,
    TAccountLpMint,
    TAccountUserPoolLp,
...
export type ParsedRemoveBalanceLiquidityInstruction<
  TProgram extends string = typeof AMM_PROGRAM_ADDRESS,
...
> = {
  ...
  data: RemoveBalanceLiquidityInstructionData;
};

export function parseRemoveBalanceLiquidityInstruction<
...
>(
  instruction: IInstruction<TProgram> &
    ...
    IInstructionWithData<Uint8Array>
): ParsedRemoveBalanceLiquidityInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getRemoveBalanceLiquidityInstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
