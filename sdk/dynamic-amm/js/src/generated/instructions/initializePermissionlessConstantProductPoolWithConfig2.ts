...
export const INITIALIZE_PERMISSIONLESS_CONSTANT_PRODUCT_POOL_WITH_CONFIG2_DISCRIMINATOR =
  new Uint8Array([48, 149, 220, 130, 61, 11, 9, 178]);

export function getInitializePermissionlessConstantProductPoolWithConfig2DiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    INITIALIZE_PERMISSIONLESS_CONSTANT_PRODUCT_POOL_WITH_CONFIG2_DISCRIMINATOR
  );
}

export type InitializePermissionlessConstantProductPoolWithConfig2Instruction<
...
export type InitializePermissionlessConstantProductPoolWithConfig2InstructionData =
  {
...
export type InitializePermissionlessConstantProductPoolWithConfig2InstructionDataArgs =
  {
...
export function getInitializePermissionlessConstantProductPoolWithConfig2InstructionDataEncoder(): Encoder<InitializePermissionlessConstantProductPoolWithConfig2InstructionDataArgs> {
...
export function getInitializePermissionlessConstantProductPoolWithConfig2InstructionDataDecoder(): Decoder<InitializePermissionlessConstantProductPoolWithConfig2InstructionData> {
...
export function getInitializePermissionlessConstantProductPoolWithConfig2InstructionDataCodec(): Codec<
  InitializePermissionlessConstantProductPoolWithConfig2InstructionDataArgs,
  InitializePermissionlessConstantProductPoolWithConfig2InstructionData
> {
  return combineCodec(
    getInitializePermissionlessConstantProductPoolWithConfig2InstructionDataEncoder(),
    getInitializePermissionlessConstantProductPoolWithConfig2InstructionDataDecoder()
  );
}

export type InitializePermissionlessConstantProductPoolWithConfig2Input<
...
> = {
  ...
  tokenAAmount: InitializePermissionlessConstantProductPoolWithConfig2InstructionDataArgs['tokenAAmount'];
  tokenBAmount: InitializePermissionlessConstantProductPoolWithConfig2InstructionDataArgs['tokenBAmount'];
  activationPoint: InitializePermissionlessConstantProductPoolWithConfig2InstructionDataArgs['activationPoint'];
};

export function getInitializePermissionlessConstantProductPoolWithConfig2Instruction<
  TAccountPool extends string,
  TAccountConfig extends string,
  TAccountLpMint extends string,
  TAccountTokenAMint extends string,
...
>(
  input: InitializePermissionlessConstantProductPoolWithConfig2Input<
    TAccountPool,
    TAccountConfig,
    TAccountLpMint,
    TAccountTokenAMint,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getInitializePermissionlessConstantProductPoolWithConfig2InstructionDataEncoder().encode(
      args as InitializePermissionlessConstantProductPoolWithConfig2InstructionDataArgs
    ),
  } as InitializePermissionlessConstantProductPoolWithConfig2Instruction<
    TProgramAddress,
    TAccountPool,
    TAccountConfig,
    TAccountLpMint,
...
export type ParsedInitializePermissionlessConstantProductPoolWithConfig2Instruction<
  TProgram extends string = typeof AMM_PROGRAM_ADDRESS,
...
> = {
  ...
  data: InitializePermissionlessConstantProductPoolWithConfig2InstructionData;
};

export function parseInitializePermissionlessConstantProductPoolWithConfig2Instruction<
...
>(
  instruction: IInstruction<TProgram> &
    ...
    IInstructionWithData<Uint8Array>
): ParsedInitializePermissionlessConstantProductPoolWithConfig2Instruction<
  TProgram,
  TAccountMetas
> {
  ...
  return {
    ...
    data: getInitializePermissionlessConstantProductPoolWithConfig2InstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
