...
export const ADD_IMBALANCE_LIQUIDITY_DISCRIMINATOR = new Uint8Array([
  79, 35, 122, 84, 173, 15, 93, 191,
]);

export function getAddImbalanceLiquidityDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    ADD_IMBALANCE_LIQUIDITY_DISCRIMINATOR
  );
}

export type AddImbalanceLiquidityInstruction<
...
export type AddImbalanceLiquidityInstructionData = {
...
export type AddImbalanceLiquidityInstructionDataArgs = {
  minimumPoolTokenAmount: number | bigint;
  tokenAAmount: number | bigint;
  tokenBAmount: number | bigint;
};

export function getAddImbalanceLiquidityInstructionDataEncoder(): Encoder<AddImbalanceLiquidityInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: ADD_IMBALANCE_LIQUIDITY_DISCRIMINATOR,
    })
  );
}

export function getAddImbalanceLiquidityInstructionDataDecoder(): Decoder<AddImbalanceLiquidityInstructionData> {
...
export function getAddImbalanceLiquidityInstructionDataCodec(): Codec<
  AddImbalanceLiquidityInstructionDataArgs,
  AddImbalanceLiquidityInstructionData
> {
  return combineCodec(
    getAddImbalanceLiquidityInstructionDataEncoder(),
    getAddImbalanceLiquidityInstructionDataDecoder()
  );
}

export type AddImbalanceLiquidityInput<
...
> = {
  ...
  minimumPoolTokenAmount: AddImbalanceLiquidityInstructionDataArgs['minimumPoolTokenAmount'];
  tokenAAmount: AddImbalanceLiquidityInstructionDataArgs['tokenAAmount'];
  tokenBAmount: AddImbalanceLiquidityInstructionDataArgs['tokenBAmount'];
};

export function getAddImbalanceLiquidityInstruction<
  TAccountPool extends string,
  TAccountLpMint extends string,
  TAccountUserPoolLp extends string,
  TAccountAVaultLp extends string,
...
>(
  input: AddImbalanceLiquidityInput<
    TAccountPool,
    TAccountLpMint,
    TAccountUserPoolLp,
    TAccountAVaultLp,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getAddImbalanceLiquidityInstructionDataEncoder().encode(
      args as AddImbalanceLiquidityInstructionDataArgs
    ),
  } as AddImbalanceLiquidityInstruction<
    TProgramAddress,
    TAccountPool,
    TAccountLpMint,
    TAccountUserPoolLp,
...
export type ParsedAddImbalanceLiquidityInstruction<
  TProgram extends string = typeof AMM_PROGRAM_ADDRESS,
...
> = {
  ...
  data: AddImbalanceLiquidityInstructionData;
};

export function parseAddImbalanceLiquidityInstruction<
...
>(
  instruction: IInstruction<TProgram> &
    ...
    IInstructionWithData<Uint8Array>
): ParsedAddImbalanceLiquidityInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getAddImbalanceLiquidityInstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
