...
export const BOOTSTRAP_LIQUIDITY_DISCRIMINATOR = new Uint8Array([
  4, 228, 215, 71, 225, 253, 119, 206,
]);

export function getBootstrapLiquidityDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    BOOTSTRAP_LIQUIDITY_DISCRIMINATOR
  );
}

export type BootstrapLiquidityInstruction<
...
export type BootstrapLiquidityInstructionData = {
  discriminator: ReadonlyUint8Array;
  tokenAAmount: bigint;
  tokenBAmount: bigint;
};

export type BootstrapLiquidityInstructionDataArgs = {
  tokenAAmount: number | bigint;
  tokenBAmount: number | bigint;
};

export function getBootstrapLiquidityInstructionDataEncoder(): Encoder<BootstrapLiquidityInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: BOOTSTRAP_LIQUIDITY_DISCRIMINATOR })
  );
}

export function getBootstrapLiquidityInstructionDataDecoder(): Decoder<BootstrapLiquidityInstructionData> {
...
export function getBootstrapLiquidityInstructionDataCodec(): Codec<
  BootstrapLiquidityInstructionDataArgs,
  BootstrapLiquidityInstructionData
> {
  return combineCodec(
    getBootstrapLiquidityInstructionDataEncoder(),
    getBootstrapLiquidityInstructionDataDecoder()
  );
}

export type BootstrapLiquidityInput<
...
> = {
  ...
  tokenAAmount: BootstrapLiquidityInstructionDataArgs['tokenAAmount'];
  tokenBAmount: BootstrapLiquidityInstructionDataArgs['tokenBAmount'];
};

export function getBootstrapLiquidityInstruction<
  TAccountPool extends string,
  TAccountLpMint extends string,
  TAccountUserPoolLp extends string,
  TAccountAVaultLp extends string,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getBootstrapLiquidityInstructionDataEncoder().encode(
      args as BootstrapLiquidityInstructionDataArgs
    ),
  } as BootstrapLiquidityInstruction<
    TProgramAddress,
    TAccountPool,
    TAccountLpMint,
    TAccountUserPoolLp,
...
export type ParsedBootstrapLiquidityInstruction<
  TProgram extends string = typeof AMM_PROGRAM_ADDRESS,
...
> = {
  ...
  data: BootstrapLiquidityInstructionData;
};

export function parseBootstrapLiquidityInstruction<
...
>(
  instruction: IInstruction<TProgram> &
    ...
    IInstructionWithData<Uint8Array>
): ParsedBootstrapLiquidityInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getBootstrapLiquidityInstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
