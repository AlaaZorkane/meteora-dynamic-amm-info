...
export const INITIALIZE_PERMISSIONLESS_POOL_DISCRIMINATOR = new Uint8Array([
  118, 173, 41, 157, 173, 72, 97, 103,
]);

export function getInitializePermissionlessPoolDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    INITIALIZE_PERMISSIONLESS_POOL_DISCRIMINATOR
  );
}

export type InitializePermissionlessPoolInstruction<
...
export type InitializePermissionlessPoolInstructionData = {
...
export type InitializePermissionlessPoolInstructionDataArgs = {
  curveType: CurveTypeArgs;
  tokenAAmount: number | bigint;
  tokenBAmount: number | bigint;
};

export function getInitializePermissionlessPoolInstructionDataEncoder(): Encoder<InitializePermissionlessPoolInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: INITIALIZE_PERMISSIONLESS_POOL_DISCRIMINATOR,
    })
  );
}

export function getInitializePermissionlessPoolInstructionDataDecoder(): Decoder<InitializePermissionlessPoolInstructionData> {
...
export function getInitializePermissionlessPoolInstructionDataCodec(): Codec<
  InitializePermissionlessPoolInstructionDataArgs,
  InitializePermissionlessPoolInstructionData
> {
  return combineCodec(
    getInitializePermissionlessPoolInstructionDataEncoder(),
    getInitializePermissionlessPoolInstructionDataDecoder()
  );
}

export type InitializePermissionlessPoolInput<
...
> = {
  ...
  curveType: InitializePermissionlessPoolInstructionDataArgs['curveType'];
  tokenAAmount: InitializePermissionlessPoolInstructionDataArgs['tokenAAmount'];
  tokenBAmount: InitializePermissionlessPoolInstructionDataArgs['tokenBAmount'];
};

export function getInitializePermissionlessPoolInstruction<
  TAccountPool extends string,
  TAccountLpMint extends string,
  TAccountTokenAMint extends string,
  TAccountTokenBMint extends string,
...
>(
  input: InitializePermissionlessPoolInput<
    TAccountPool,
    TAccountLpMint,
    TAccountTokenAMint,
    TAccountTokenBMint,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getInitializePermissionlessPoolInstructionDataEncoder().encode(
      args as InitializePermissionlessPoolInstructionDataArgs
    ),
  } as InitializePermissionlessPoolInstruction<
    TProgramAddress,
    TAccountPool,
    TAccountLpMint,
    TAccountTokenAMint,
...
export type ParsedInitializePermissionlessPoolInstruction<
  TProgram extends string = typeof AMM_PROGRAM_ADDRESS,
...
> = {
  ...
  data: InitializePermissionlessPoolInstructionData;
};

export function parseInitializePermissionlessPoolInstruction<
...
>(
  instruction: IInstruction<TProgram> &
    ...
    IInstructionWithData<Uint8Array>
): ParsedInitializePermissionlessPoolInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getInitializePermissionlessPoolInstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
