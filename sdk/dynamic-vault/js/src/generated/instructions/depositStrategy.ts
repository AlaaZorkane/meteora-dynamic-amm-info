...
export const DEPOSIT_STRATEGY_DISCRIMINATOR = new Uint8Array([
  246, 82, 57, 226, 131, 222, 253, 249,
]);

export function getDepositStrategyDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    DEPOSIT_STRATEGY_DISCRIMINATOR
  );
}

export type DepositStrategyInstruction<
...
export type DepositStrategyInstructionData = {
  discriminator: ReadonlyUint8Array;
  amount: bigint;
};

export type DepositStrategyInstructionDataArgs = { amount: number | bigint };

export function getDepositStrategyInstructionDataEncoder(): Encoder<DepositStrategyInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ['discriminator', fixEncoderSize(getBytesEncoder(), 8)],
      ['amount', getU64Encoder()],
    ]),
    (value) => ({ ...value, discriminator: DEPOSIT_STRATEGY_DISCRIMINATOR })
  );
}

export function getDepositStrategyInstructionDataDecoder(): Decoder<DepositStrategyInstructionData> {
...
export function getDepositStrategyInstructionDataCodec(): Codec<
  DepositStrategyInstructionDataArgs,
  DepositStrategyInstructionData
> {
  return combineCodec(
    getDepositStrategyInstructionDataEncoder(),
    getDepositStrategyInstructionDataDecoder()
  );
}

export type DepositStrategyInput<
...
> = {
  ...
  amount: DepositStrategyInstructionDataArgs['amount'];
};

export function getDepositStrategyInstruction<
  TAccountVault extends string,
  TAccountStrategy extends string,
  TAccountTokenVault extends string,
  TAccountFeeVault extends string,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getDepositStrategyInstructionDataEncoder().encode(
      args as DepositStrategyInstructionDataArgs
    ),
  } as DepositStrategyInstruction<
    TProgramAddress,
    TAccountVault,
    TAccountStrategy,
    TAccountTokenVault,
...
export type ParsedDepositStrategyInstruction<
  TProgram extends string = typeof VAULT_PROGRAM_ADDRESS,
...
> = {
  ...
  data: DepositStrategyInstructionData;
};

export function parseDepositStrategyInstruction<
...
>(
  instruction: IInstruction<TProgram> &
    ...
    IInstructionWithData<Uint8Array>
): ParsedDepositStrategyInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getDepositStrategyInstructionDataDecoder().decode(instruction.data),
  };
}
